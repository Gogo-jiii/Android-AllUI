...
public class ToolbarManager {
    ...
    private void setupBackButton(Context context, Toolbar toolbar) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            toolbar.setNavigationIcon(context.getResources().getDrawable(R.drawable.ic_arrow_back,
                    null));
        }
    }
    ...
    //-AppConfiguration
    public AppBarConfiguration setTopLevelDestinations() {
        HashSet<Integer> topLevelDestinations = new HashSet<>();
//        topLevelDestinations.add(R.id.frag1);
//        topLevelDestinations.add(R.id.frag2);
    ...
    public void setupNavigationDrawer(AppCompatActivity activity, NavController navController,
        ...
        //Burger menu on every fragment
        NavigationUI.setupWithNavController(toolbar2, navController, setTopLevelDestinationsForNavDrawer(drawerLayout));

        //Burger menu on just first fragment
    ...
    private AppBarConfiguration setTopLevelDestinationsForNavDrawer(DrawerLayout drawerLayout) {
        HashSet<Integer> topLevelDestinations = new HashSet<>();
        topLevelDestinations.add(R.id.frag1);
        topLevelDestinations.add(R.id.frag2);
